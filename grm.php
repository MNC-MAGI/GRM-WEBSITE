...
<body>
<div class="title">
<center><a href=https://cubonline.biz/StudentLogin?Instname=SGGHSS><input type="submit"  value="Online Fee Payment"><a href="doc\appeal-grm.pdf" target="_blank"><input type="submit"  value="APPEAL"><label> Sri GRM Girls Govt.Aided Higher Secondary School </label><br><label> THIRUVARUR</label>
</center>
  ...
  <div class="wrapper">
    <nav>
      ...
      <div class="content">
      <div class="logo">
        <img src="image/logo2.jpg" height="77">
      </div>
        <ul class="links">
          <li><a href="#">HOME</a></li>
          <li>
...
<section class="foot">
  <div class="mapp-l">
    <h2 style="color: white; margin-top: -120px; font-weight: 290;">GET INTO TOUCH</h2>
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1385.7525287552598!2d79.63195331159227!3d10.772961548659557!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a55473cb124db6f%3A0x78c0268b0d86da9e!2sSri%20GRM%20Girls%20Higher%20Secondary%20School!5e0!3m2!1sen!2sus!4v1761417006900!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

  </div>
  <div class="add-l">
    <h3>Karaikaatu Street,</h3>
    <p> Thiruvarur, Tamil Nadu 610001</p>
    <p>+91 - 04366 - 222 363</p>
     </div>
  <div class="link-l">
    <h3>Social</h3>
    ...
    <br>
    <h3>OUR SCHOOLS</h3>
<a href="vsbhome.php" target="_blank"><label>V S BOYS HR SEC SCHOOL</label></a>   <br>  
<a href="grm.php">SRI GRM SCHOOL</a>     <br>
<a href="thiyaga.php">THIYAGARAJA SCHOOL</a>     
  </div>  
  <br>
